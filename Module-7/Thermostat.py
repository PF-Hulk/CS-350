...
#         Author         |         Date
#------------------------------------------------------------------
# Christopher Davidson           10/19/2025
#------------------------------------------------------------------
#
# ------------------------------------------------------------------
# Change History
...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        # Update lights according to current temp vs setpoint
        self.updateLights()
    ...
    def on_exit_heat(self):
        ## Make sure the red LED is not left on in a solid or pulsing state
        redLight.off()
    ...
    def on_exit_cool(self):
        # Make sure the blue LED is not left on in a solid or pulsing state
        blueLight.off()
    ...
    def on_enter_off(self):
        # Both indicators off in an off state
        redLight.off()
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        # Cycle through off, heat, and cool, then back to off
        self.cycle()
    ...
    def updateLights(self):
        ...
        # Heat mode: If below setpoint the red LED fades.
        # If at or above setpoint, the red LED is solid.
        if state == 'heat':
            if temp < self.setPoint:
                redLight.pulse(fade_in_time=1, fade_out_time=1, n=None, background=True)
            else:
                redLight.on()
        # Cool mode: If above setpoint, the blue LED fades.
        # If at or below setpoint, the blue LED is solid.
        elif state == 'cool':
            if temp > self.setPoint:
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if (altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state.id.capitalize()} SP:{self.setPoint}F".ljust(16)
